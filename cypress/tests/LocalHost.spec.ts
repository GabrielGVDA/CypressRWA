...
describe('Enviar dinheiro com saldo suficiente', () => {
        it('Deve enviar dinheiro com sucesso', () => {
            ...
            // cy.get('#bankaccount-bankName-input').type('furia')
...
describe('Visualizar histórico de transações com sucesso', () => {
     ...
     // Implemente os passos do caso de teste aqui
          ...
          // cy.get('[data-test="user-onboarding-next"]')
          //  cy.get('[data-test="bankaccount-submit"]').click()
          //  cy.get('#bankaccount-bankName-input').type('Ghennos')
          // cy.get('#bankaccount-routingNumber-input').type('125125125')
          // cy.get('#bankaccount-accountNumber-input').type('125125125')
          // cy.get('[data-test="bankaccount-form"] > .MuiGrid-container > .MuiGrid-root').click()
          cy.get('[data-test="nav-top-new-transaction"]').click()
          cy.get('[data-test="user-list-item-uBmeaz5pX"] > .MuiListItemText-root > .MuiTypography-body1').click()
